    ...
    public class ClaimService : IClaimService
    {
        ...
        public bool CreateClaim(string strMitchellClaimXML)
        {
            ...
            try
            {
                ...
                MitchellClaimXML.Save(HttpContext.Current.Server.MapPath("App_Data/temp.xml"));
            }
            catch 
            {
                return false;
            ...
            if (IsValidXml(HttpContext.Current.Server.MapPath("App_Data/temp.xml"), xmlNamespace, HttpContext.Current.Server.MapPath(strXSDPath)))
            {
                try
                {
        ...
        public MitchellClaimType GetClaimByClaimNumber(string claimNumberField)
        {
            try
            {
                ...
                XDocument claimXML = XDocument.Load(HttpContext.Current.Server.MapPath(strXMLClaimStore));
        ...
        private bool SaveNewClaim(MitchellClaimType newClaim)
        {
            ...
            {
                // Load the backing store
                XDocument claimStore = XDocument.Load(HttpContext.Current.Server.MapPath(strXMLClaimStore));
                ...
                claimStore.Save(HttpContext.Current.Server.MapPath(strXMLClaimStore));
            }
            catch
            {
                added = false;
