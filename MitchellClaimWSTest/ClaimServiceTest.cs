...
namespace MitchellClaimWSTest
{
    ...
    public class ClaimServiceTest
    {
        ...
        static readonly MitchellClaimWSReference.ClaimServiceClient claimService = new MitchellClaimWSReference.ClaimServiceClient();
        ...
        public void testGetClaimByClaimNumberClaimExists()
        {
            ...
            Assert.AreEqual("1", claimService.GetClaimByClaimNumber("1").claimNumberField);
        }
        ...
        {
            Assert.AreEqual(0, claimService.GetClaimsBetweenDates(DateTime.Now.AddYears(100), DateTime.Now.AddYears(100)).Length);
        }
